...
const CustomerSignature = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.instructions}>
            Please have the customer sign below to confirm satisfaction with the completed work
          </Text>
          <SignaturePad
            onSave={handleSave}
            onClear={handleClear}
      ...
      >
        <Text style={styles.saveButtonText}>Save Customer Signature</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
};
