          ...
          <View style={styles.modalBody}>
            ...
            >
              <View style={[
                ...
                {tempAgreed && <Icon name="check" size={16} color="#fff" />}
              </View>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.customerCard}>
                <View style={styles.customerHeader}>
                  ...
                  <TouchableOpacity 
                    onPress={() => navigation.navigate('NavigateMap', {
                      location: jobData.location,
                      locationName: jobData.locationName,
                      customerName: jobData.customerName,
                      jobNo: jobNo,
                ...
                <View key={index} style={styles.taskCard}>
                  ...
                  <View style={styles.taskRequirements}>
                    <View style={styles.requirementsContainer}>
                      {(task.requiredNotes || task.requiredPhotos) && (
                        <Text style={styles.requirementsText}>
                          Required: {[
                            task.requiredNotes && 'Notes',
                            task.requiredPhotos && 'Photos'
                          ].filter(Boolean).join(', ')}
                        </Text>
                      )}
                      {task.completedBy && (
                        <Text style={styles.completedByText}>
                          Completed by: {workerDetails[task.completedBy]?.fullName || task.completedBy}
                        </Text>
                      )}
                      {task.completionDate && (
                        <Text style={styles.completionDate}>
                          on {new Date(task.completionDate).toLocaleDateString()}
                        </Text>
                      )}
                    </View>
                  </View>
