...
const JobDetailsBackup = ({ navigation, route }) => {
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.eventDescContainer}>
          <View style={styles.eventCategoryContainer}>
            <Text style={styles.eventCategory}>Assigned Workers</Text>
          </View>
        ...
        <View style={styles.eventFeatureContainer}>
          ...
          <View style={styles.eventFeatureTextContainer}>
            ...
            }]}>{job.startTime}AM - {job.endTime}PM</Text>
        ...
        <Text style={[styles.description, {
          color: COLORS.grayscale700,
        }]} numberOfLines={expanded ? undefined : 2}>{job.description}</Text>
...
{/* 
        ...
        <View style={styles.eventItemContainer}>
          ...
          <Text style={[styles.locationText, {
            color: COLORS.grayscale700,
          }]}>{job.locationName} {job.streetAddress}</Text>
        </View> */}
{/* 
...
export default JobDetailsBackup
